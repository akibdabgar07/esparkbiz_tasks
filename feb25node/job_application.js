...
app.post('/updated', function (req, res) {
    ...
    async function updateddata() {
        try {
            ...
            const result83 = await queryDb(tname);
            ...
            const lname = `delete from preferd_location_city where c_id='${edit}'`;
            const result85 = await queryDb(lname);
            ...
            const result86 = await queryDb(pname);
